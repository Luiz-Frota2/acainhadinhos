...
📌 1. aberturas
Finalidade:
Registra a abertura e o fechamento do caixa por operador.
...
status: controla se o caixa está aberto ou fechado.

empresa_id: útil para multiempresas.

📌 2. sangrias
Finalidade:
Registra cada retirada de dinheiro do caixa.
...
abertura_id liga essa sangria à abertura correspondente.

📌 3. suprimentos
Finalidade:
Registra cada entrada de dinheiro extra no caixa.
...
Mesma estrutura de sangria, porém com entrada de valores.

📌 4. vendas
Finalidade:
Registra todas as vendas realizadas enquanto o caixa estiver aberto.
...
Você pode somar vendas por abertura com WHERE status = 'ativa'.