            ...
            <div class="col-lg-8 mb-4 order-0">
              <div class="card">
                <div class="d-flex align-items-end row">
                  <div class="col-sm-8">
                    <div class="card-body">
                      <h5 class="card-title text-primary saudacao" data-setor="Sistema de Ponto"></h5>
                      <p class="mb-4">Suas configurações do Sistema de Ponto foram atualizadas em seu perfil. Continue
