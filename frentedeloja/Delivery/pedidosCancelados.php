        ...
        <div class="layout-container">
            ...
            <div class="layout-page">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <div class="card">
                        <h5 class="card-header">Pedidos Cancelados</h5>
                            ...
                            <table class="table text-nowrap">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>1401</td>
                                        <td>Rafael Lima</td>
                                        <td>Rua Beira Rio, 150</td>
                                        <td>Pix</td>
                                        <td><strong>R$ 22,90</strong></td>
                                        <td>18:35</td>
                                        <td>
                                            <div class="d-flex gap-2">
                                                <button class="btn btn-secondary btn-sm"
                                                    data-bs-toggle="modal" data-bs-target="#acao1401">
                                                    Ações
                                                </button>
                                                <button class="btn btn-primary btn-sm"
                                                    data-bs-toggle="modal" data-bs-target="#itens1401">
                                                    Itens
                                                </button>
                                            </div>
                                        </td>
                                    ...
                                    <!-- MODAL AÇÕES 1401 -->
                                    <div class="modal fade" id="acao1401">
                                        <div class="modal-dialog modal-dialog-scrollable modal-dialog-top">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title">Ações do pedido #1401</h5>
                                    ...
                                    <!-- MODAL ITENS 1401 -->
                                    <div class="modal fade" id="itens1401">
                                        <div class="modal-dialog modal-dialog-scrollable modal-dialog-top">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title">Itens do Pedido #1401</h5>
                                                    <button class="btn-close" data-bs-dismiss="modal"></button>
                                                </div>
                                                <div class="modal-body">
                                                    <ul>
                                    ...
                                    <tr>
                                        <td>1402</td>
                                        <td>Camila Duarte</td>
                                        <td>Av. Getúlio Vargas, 765</td>
                                        <td>Crédito</td>
                                        <td><strong>R$ 28,00</strong></td>
                                        <td>19:10</td>
                                        <td>
                                            <div class="d-flex gap-2">
                                                <button class="btn btn-secondary btn-sm"
                                                    data-bs-toggle="modal" data-bs-target="#acao1402">
                                                    Ações
                                                </button>
                                                <button class="btn btn-primary btn-sm"
                                                    data-bs-toggle="modal" data-bs-target="#itens1402">
                                                    Itens
                                                </button>
                                            </div>
                                        </td>
                                    ...
                                    <!-- MODAL AÇÕES 1402 -->
                                    <div class="modal fade" id="acao1402">
                                        <div class="modal-dialog modal-dialog-scrollable modal-dialog-top">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title">Ações do pedido #1402</h5>
                                                    <button class="btn-close" data-bs-dismiss="modal"></button>
                                                </div>
                                                <div class="modal-body">
                                                    <label class="form-label">Selecione uma ação:</label>
                                    ...
                                    <!-- MODAL ITENS 1402 -->
                                    <div class="modal fade" id="itens1402">
                                        <div class="modal-dialog modal-dialog-scrollable modal-dialog-top">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title">Itens do Pedido #1402</h5>
                                                    <button class="btn-close" data-bs-dismiss="modal"></button>
                                                </div>
                                                <div class="modal-body">
                                                    <ul>
