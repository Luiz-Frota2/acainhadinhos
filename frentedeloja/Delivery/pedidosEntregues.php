        ...
        <div class="layout-container">
            ...
            <div class="layout-page">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <div class="card">
                        <h5 class="card-header">Pedidos Entregues</h5>
                            ...
                            <table class="table text-nowrap">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>Rua das Mangueiras, 210</td>
                                        <td>Pix</td>
                                        <td><strong>R$ 26,90</strong></td>
                                        <td>20:05</td>
                                        <td>
                                            <div class="d-flex gap-2">
                                                <button class="btn btn-secondary btn-sm"
                                                    data-bs-toggle="modal" data-bs-target="#acao1301">
                                                    Ações
                                                </button>
                                                <button class="btn btn-primary btn-sm"
                                                    data-bs-toggle="modal" data-bs-target="#itens1301">
                                                    Itens
                                                </button>
                                            </div>
                                        </td>
                                    ...
                                    <!-- MODAL AÇÕES 1301 -->
                                    <div class="modal fade" id="acao1301">
                                        <div class="modal-dialog modal-dialog-scrollable modal-dialog-top">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title">Ações do pedido #1301</h5>
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <select class="form-select">
                                                        ...
                                                        <option value="comprovante">Reenviar comprovante</option>
                                    ...
                                    <!-- MODAL ITENS 1301 -->
                                    <div class="modal fade" id="itens1301">
                                        <div class="modal-dialog modal-dialog-scrollable modal-dialog-top">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title">Itens do Pedido #1301</h5>
                                                    <button class="btn-close" data-bs-dismiss="modal"></button>
                                                </div>
                                                <div class="modal-body">
                                                    <ul>
                                    ...
                                    <tr>
                                        <td>1302</td>
                                        <td>Bianca Melo</td>
                                        <td>Av. Principal, 980</td>
                                        <td>Crédito</td>
                                        <td><strong>R$ 31,50</strong></td>
                                        <td>20:18</td>
                                        <td>
                                            <div class="d-flex gap-2">
                                                <button class="btn btn-secondary btn-sm"
                                                    data-bs-toggle="modal" data-bs-target="#acao1302">
                                                    Ações
                                                </button>
                                                <button class="btn btn-primary btn-sm"
                                                    data-bs-toggle="modal" data-bs-target="#itens1302">
                                                    Itens
                                                </button>
                                            </div>
                                        </td>
                                    ...
                                    <!-- MODAL AÇÕES 1302 -->
                                    <div class="modal fade" id="acao1302">
                                        <div class="modal-dialog modal-dialog-scrollable modal-dialog-top">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title">Ações do pedido #1302</h5>
                                                    <button class="btn-close" data-bs-dismiss="modal"></button>
                                                </div>
                                                <div class="modal-body">
                                                    <label class="form-label">Selecione uma ação:</label>
                                    ...
                                    <!-- MODAL ITENS 1302 -->
                                    <div class="modal fade" id="itens1302">
                                        <div class="modal-dialog modal-dialog-scrollable modal-dialog-top">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title">Itens do Pedido #1302</h5>
                                                    <button class="btn-close" data-bs-dismiss="modal"></button>
                                                </div>
                                                <div class="modal-body">
                                                    <ul>
