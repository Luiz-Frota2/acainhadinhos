    ...
    <div class="layout-wrapper layout-content-navbar">
        <div class="layout-container">
            ...
            <div class="layout-page">
                ...
                <!-- =====================================================
                     CONTEÚDO - AQUI MUDEI PARA "PEDIDOS ACEITOS"
                ====================================================== -->
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <div class="card">
                        <h5 class="card-header">Pedidos Aceitos</h5>
                        ...
                        <div class="table-responsive">
                            <table class="table text-nowrap">
                                ...
                                <tbody>
                                        ...
                                        <td>
                                            <div class="d-flex gap-2">
                                                <button class="btn btn-secondary btn-sm"
                                                    data-bs-toggle="modal" data-bs-target="#acao1101">
                                                    Ações
                                                </button>
                                                <button class="btn btn-primary btn-sm"
                                                    data-bs-toggle="modal" data-bs-target="#itens1101">
                                                    Itens
                                                </button>
                                            </div>
                                        </td>
                                    ...
                                    <!-- MODAL AÇÕES 1101 -->
                                    <div class="modal fade" id="acao1101">
                                        <div class="modal-dialog modal-dialog-scrollable modal-dialog-top">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title">Atualizar status do pedido #1101</h5>
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <select class="form-select">
                                                        ...
                                                        <option value="caminho">Marcar como A Caminho</option>
                                    ...
                                    <!-- MODAL ITENS 1101 -->
                                    <div class="modal fade" id="itens1101">
                                        <div class="modal-dialog modal-dialog-scrollable modal-dialog-top">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title">Itens do Pedido #1101</h5>
                                                    <button class="btn-close" data-bs-dismiss="modal"></button>
                                                </div>
                                                <div class="modal-body">
                                                    <ul>
                                    ...
                                    <tr>
                                        <td>1102</td>
                                        <td>Carla Santos</td>
                                        <td>Avenida Brasil, 890</td>
                                        <td>Crédito</td>
                                        <td><strong>R$ 27,50</strong></td>
                                        <td>19:20</td>
                                        <td>
                                            <div class="d-flex gap-2">
                                                <button class="btn btn-secondary btn-sm"
                                                    data-bs-toggle="modal" data-bs-target="#acao1102">
                                                    Ações
                                                </button>
                                                <button class="btn btn-primary btn-sm"
                                                    data-bs-toggle="modal" data-bs-target="#itens1102">
                                                    Itens
                                                </button>
                                            </div>
                                        </td>
                                    ...
                                    <!-- MODAL AÇÕES 1102 -->
                                    <div class="modal fade" id="acao1102">
                                        <div class="modal-dialog modal-dialog-scrollable modal-dialog-top">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title">Atualizar status do pedido #1102</h5>
                                                    <button class="btn-close" data-bs-dismiss="modal"></button>
                                                </div>
                                                <div class="modal-body">
                                                    <label class="form-label">Selecione o novo status:</label>
                                    ...
                                    <!-- MODAL ITENS 1102 -->
                                    <div class="modal fade" id="itens1102">
                                        <div class="modal-dialog modal-dialog-scrollable modal-dialog-top">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title">Itens do Pedido #1102</h5>
                                                    <button class="btn-close" data-bs-dismiss="modal"></button>
                                                </div>
                                                <div class="modal-body">
                                                    <ul>
