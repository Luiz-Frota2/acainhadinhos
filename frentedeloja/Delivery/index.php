                                ...
                                <div class="d-flex align-items-end row">
                                    <div class="col-sm-7">
                                        <div class="card-body">
                                            ...
                                            <p class="mb-4">Veja as configurações do Delivery que foram atualizadas em
                                                seu perfil. Continue
                                    ...
                                    <div class="col-sm-5 text-center text-sm-left">
                                        <div class="card-body pb-0 px-0 px-md-4">
                                            <img src="../../assets/img/illustrations/man-with-laptop-light.png"
                                                height="140" alt="Painel Açaínhadinhos"
                            ...
                            <div class="card h-100">
                                <div class="d-flex flex-column flex-md-row h-100">
                                    ...
                                    <div class="col-12 col-md-8 d-flex flex-column order-2 order-md-1">
                                        ...
                                        <div id="salesChannelChart" class="px-2 flex-grow-1" style="min-height: 150px;">
                                        </div>
                                    </div>
                                    ...
                                    <div
                                            ...
                                            <div class="text-center">
                                                <div class="dropdown">
                                                    <button class="btn btn-sm btn-outline-primary dropdown-toggle"
                                                        type="button" id="salesReportId" data-bs-toggle="dropdown"
                                                        aria-haspopup="true" aria-expanded="false">
                                                        Hoje
                                                    </button>
                                                    <div class="dropdown-menu dropdown-menu-end"
                                                        aria-labelledby="salesReportId">
                                                        <a class="dropdown-item" href="javascript:void(0);">Ontem</a>
                                                        <a class="dropdown-item" href="javascript:void(0);">Esta
                                                            Semana</a>
                                        ...
                                        <div id="channelTrendChart" class="flex-grow-1 px-2" style="min-height: 150px;">
                                        </div>

                                        <div class="text-center fw-semibold pt-3 mb-2">Conversão Delivery: 65%</div>

                                        <div
                                            class="d-flex px-xxl-4 px-lg-2 p-4 gap-xxl-3 gap-lg-1 gap-3 justify-content-between flex-wrap">
                                            <div class="d-flex mb-2 mb-md-0">
                                                <div class="me-2">
                                                    <span class="badge bg-label-primary p-2"><i
                                                            class="bx bx-store text-primary"></i></span>
                                                </div>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-4 order-2 order-md-1 mb-4">
                            <div class="card h-100">
                                <div class="card-header d-flex align-items-center justify-content-between pb-0">
                                    ...
                                    <div class="dropdown">
                                        <button class="btn p-0" type="button" id="topCombinations"
                        ...
                        <div class="col-md-6 col-lg-4 order-3 order-md-3 mb-4">
                            <div class="card h-100">
                                <div class="card-header d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="dropdown">
                                        <button class="btn p-0" type="button" id="recentOrders"
                                            data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            <i class="bx bx-dots-vertical-rounded"></i>
                                        </button>
                                ...
                                <div class="card-body">
                                    <ul class="p-0 m-0">
                                        ...
                                        <li class="d-flex mb-4 pb-1">
                                            ...
                                            <div
                                                class="d-flex w-100 align-items-center justify-content-between gap-2 flex-wrap">
                                                <div class="me-2" style="flex: 1; min-width: 0;">
                                                    <h6 class="mb-0 text-truncate">#458 - Presencial</h6>
                                                    <small class="text-muted text-truncate d-block"
                                                        style="max-width: 200px;">Açaí Tradicional +
                                                        Granola</small>
                                        ...
                                        <li class="d-flex mb-4 pb-1">
                                            ...
                                            <div
                                                ...
                                                <div class="me-2" style="flex: 1; min-width: 0;">
                                                    ...
                                                    <small class="text-muted text-truncate d-block"
                                                        style="max-width: 200px;">2 Açaí Médio +
                                                        Nutella</small>
                                        ...
                                        <li class="d-flex mb-4 pb-1">
                                            ...
                                            <div
                                                ...
                                                <div class="me-2" style="flex: 1; min-width: 0;">
                                                    ...
                                                    <small class="text-muted text-truncate d-block"
                                                        style="max-width: 200px;">Açaí Fitness +
                                                        Whey</small>
                                        ...
                                        <li class="d-flex mb-4 pb-1">
                                            ...
                                            <div
                                                ...
                                                <div class="me-2" style="flex: 1; min-width: 0;">
                                                    ...
                                                    <small class="text-muted text-truncate d-block"
                                                        style="max-width: 200px;">Açaí Familiar + 6
                                        ...
                                        <li class="d-flex">
                                            ...
                                            <div
                                                ...
                                                <div class="me-2" style="flex: 1; min-width: 0;">
                                                    ...
                                                    <small class="text-muted text-truncate d-block"
                                                        style="max-width: 200px;">Açaí Pequeno + Leite
                                                        Condensado</small>
