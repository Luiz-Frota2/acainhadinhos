...
// Validação do formato do identificador
...
try {
  ...
  $stmtUnidades = $pdo->query("SELECT id, nome FROM unidades ORDER BY nome");
            ...
            <form id="formAuthentication" class="mb-3" action="../frentedeloja/login/processarCadastro.php" method="POST">
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="usuario" name="usuario"
                  placeholder="Digite seu nome de usuário" autofocus required />
              </div>
              ...
              <div class="mb-3">
                ...
                <select name="empresa_identificador" id="empresa" class="form-select" required>
                  ...
                  <?php foreach ($empresas as $empresa): ?>
                    <option value="<?= htmlspecialchars($empresa['id']) ?>" <?= $empresa['id'] === $idSelecionado ? 'selected' : '' ?>>
