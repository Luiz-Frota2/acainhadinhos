            ...
            <div class="authentication-inner py-4">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="mb-4">Digite sua nova senha para redefinir o acesso.</p>

                        <form id="formRedefinirSenha" class="mb-3" method="POST" action="../frentedeloja/login/processarNovaSenha.php">
