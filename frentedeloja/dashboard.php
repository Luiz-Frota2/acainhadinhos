...
<head>
  ...
  <title>ERP - Frente de Loja</title>
            ...
            <div class="col-lg-8 mb-4 order-0">
              <div class="card">
                <div class="d-flex align-items-end row">
                  <div class="col-sm-7">
                    <div class="card-body">
                      <h5 class="card-title text-primary saudacao" data-setor="Frente de Loja">
                      </h5>
                      <p class="mb-4">Bem-vindo ao painel Açaínhadinhos. Monitore vendas físicas, delivery, clientes e
                        estoque em tempo real.</p>
                    </div>
                  </div>
