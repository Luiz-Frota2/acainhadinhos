    ...
    <body>
            ...
            <div class="card">
                ...
                <div class="d-flex">
                    ...
                    <div class="container-img-sobre"
                        style="background-image: url('./assets/img/favicon/logo.png');"></div>

                    <div class="infos">
                        <h1 class="title-sobre"><b>Açaidinhos</b></h1>
                        <div class="infos-sub">
                            <p class="sobre mb-2">
        ...
        <section class="lista width-fix mt-5 pb-5">
            ...
            <div class="container-group mb-5">
                ...
                <div class="card mt-2">
                    <p class="normal-text mb-0">Rua Olá Mundo, 123 - Meu Bairro</p>
                </div>
            </div>
        ...
        <a href="./index.html" class="btn btn-yellow btn-full voltar">
