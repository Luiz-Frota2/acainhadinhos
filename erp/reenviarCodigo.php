...
try {
    ...
    $stmt = $pdo->prepare("SELECT id, usuario FROM contas_acesso WHERE email = :email AND empresa_id = :empresa_id");
    ...
    if ($usuario) {
        ...
        if (mail($email, $assunto, $mensagem, $headers)) {
            echo "<script>
                ...
                window.location.href = '../../../erp/verificarCodigo.php?id=" . urlencode($idSelecionado) . "&email=" . urlencode($email) . "';
            </script>";
        } else {
