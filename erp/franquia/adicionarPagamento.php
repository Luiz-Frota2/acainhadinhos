        ...
        <div class="layout-container">
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item active open">
                        ...
                        <ul class="menu-sub">
                            ...
                            <li class="menu-item">
                                <a href="./transferenciasPendentes.php?id=<?= urlencode($idSelecionado); ?>"
                                    class="menu-link">
                            ...
                            <li class="menu-item">
                                <a href="./historicoTransferencias.php?id=<?= urlencode($idSelecionado); ?>"
                                    class="menu-link">
            ...
            <div class="layout-page">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <h4 class="fw-bold mb-0"><span class="text-muted fw-light"><a href="#">Filial</a>/</span>Contas das
                        Filiais</h4>
                    <h5 class="fw-bold mt-3 mb-3 custor-font"><span class="text-muted fw-light">Adicionar Pagamento para
                            Filial</span></h5>
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title mb-4"></h5>
                            <form action="../../assets/php/filial/adicionarPagamentosFilial.php" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="id_filial" name="id_filial" required>
                                        ...
                                        try {
                                            $stmtFiliais = $pdo->query("SELECT id_filial, nome FROM filiais WHERE status = 'Ativa' ORDER BY nome ASC");
                                            $filiais = $stmtFiliais->fetchAll(PDO::FETCH_ASSOC);
                                            foreach ($filiais as $filial) {
                                                echo '<option value="' . htmlspecialchars($filial['id_filial']) . '">' . htmlspecialchars($filial['nome']) . '</option>';
                                            }
                                        } catch (PDOException $e) {
                                ...
                                <button type="submit" class="col-12 col-md-12 btn btn-primary">Adicionar Pagamento</button>
                            </form>
                        </div>
                    </div>
