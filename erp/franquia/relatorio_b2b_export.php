...
if ($tipo === 'print') {
    ...
    <body>
                ...
                <?php foreach ($resumo as $metric => $vals): ?>
                    <tr>
                        ...
                        <td>
                            <?php
                            echo match ($metric) {
                                "Pedidos B2B" => "Somente solicitações feitas por franquia",
        ...
        <!-- SEÇÃO 2: FILIAIS -->
        <div class="section-title">Vendas / Pedidos por Franquia</div>
        <table>
            <thead>
                <tr>
                    <th>Franquia</th><th>Pedidos</th><th>Itens</th><th>Faturamento (R$)</th><th>Ticket Médio (R$)</th><th>% do Total</th>
                </tr>
            </thead>
            <tbody>
        ...
        <table>
            ...
            <tbody>
                <?php if (!empty($produtosLista)): ?>
                    ...
                    <?php endforeach; ?>
                <?php else: ?>
                    <tr><td colspan="5" style="text-align:center;">Nenhum produto solicitado por franquia no período.</td></tr>
                <?php endif; ?>
            </tbody>
        </table>
