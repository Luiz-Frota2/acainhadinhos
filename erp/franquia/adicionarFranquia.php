        ...
        <ul class="menu-inner py-1">
          ...
          <li class="menu-item">
            ...
            <ul class="menu-sub">
              <!-- Contas das Filiais -->
              <li class="menu-item">
                <a href="./contasFranquias.php?id=<?= urlencode($idSelecionado); ?>" class="menu-link">
      ...
      <div class="layout-page">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
          <h4 class="fw-bold mb-0">
            <span class="text-muted fw-light"><a href="./franquiaAdicionada.php?id=<?= urlencode($idSelecionado); ?>">Franquia</a> /</span>Adicionar Franquia
            <h5 class="fw-bold mt-3 mb-3 custor-font">
              <span class="text-muted fw-light">Adicione as Franquias da empresa</span>
            </h5>


            <div class="card mt-4">
              <h5 class="card-header">Adicionar Franquia</h5>

              <div class="card-body">

                <form action="../../assets/php/franquia/adicionarUnidade.php" method="POST" id="formAdicionarFranquia">
                  ...
                  <div class="row">
                    ...
                    <div class="mb-3 col-12 col-md-6">
                      <label for="nomeUnidade" class="form-label">Nome da Franquia</label>
