    ...
    <div class="layout-container">
        ...
        <ul class="menu-inner py-1">
          ...
          <li class="menu-item open">
            ...
            <ul class="menu-sub">
              ...
              <li class="menu-item"><a class="menu-link" href="./transferenciasPendentes.php?id=<?= urlencode($idSelecionado); ?>"><div>Transf. Pendentes</div></a></li>
          ...
          <li class="menu-item active">
            ...
            <ul class="menu-sub">
              <li class="menu-item"><a class="menu-link" href="./VendasFiliais.php?id=<?= urlencode($idSelecionado); ?>"><div>Vendas por Franquias</div></a></li>
              <li class="menu-item active"><a class="menu-link" href="./MaisVendidos.php?id=<?= urlencode($idSelecionado); ?>"><div>Mais Vendidos</div></a></li>
              <li class="menu-item"><a class="menu-link" href="./vendasPeriodo.php?id=<?= urlencode($idSelecionado); ?>"><div>Vendas por Período</div></a></li>
              <li class="menu-item"><a class="menu-link" href="./FinanceiroFranquia.php?id=<?= urlencode($idSelecionado); ?>"><div>Financeiro</div></a></li>
            </ul>
          </li>
      ...
      <div class="layout-page">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
          ...
          <div class="card mb-3">
            <h5 class="card-header">Top 20 Produtos <?= $franquiaFiltro ? '(Franquia selecionada)' : '(Geral)' ?></h5>
                ...
                <tbody>
                  ...
                  <?php $pos=1; foreach($topGeral as $row): ?>
                    <tr>
                      ...
                      <td class="text-end"><?= inteiro($row['qtd_total'] ?? 0) ?></td>
                      <td class="text-end"><?= inteiro($row['pedidos'] ?? 0) ?></td>
                      <td class="text-end"><?= moeda($row['faturamento'] ?? 0) ?></td>
                    </tr>
                  <?php endforeach; ?>
                </tbody>
              </table>
            ...
            <div class="table-responsive">
              <table class="table table-hover align-middle">
                ...
                <tbody>
                  ...
                  <?php foreach($rankFranq as $fid => $lista): ?>
                    <?php foreach($lista as $linha): ?>
                      <tr>
                        <td><strong><?= htmlspecialchars($linha['franquia']) ?></strong></td>
                        <td><?= htmlspecialchars($linha['sku'] ?? '-') ?></td>
                        <td><?= htmlspecialchars($linha['nome_produto'] ?? '-') ?></td>
                        <td class="text-end"><?= inteiro($linha['qtd_total'] ?? 0) ?></td>
                        <td class="text-end"><?= inteiro($linha['pedidos'] ?? 0) ?></td>
                      </tr>
                    <?php endforeach; ?>
                  <?php endforeach; ?>
                </tbody>
