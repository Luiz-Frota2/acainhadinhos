...
// ===================== FILTRO SQL DINÂMICO =====================
$filtro = " s.created_at BETWEEN :dataInicio AND :dataFim ";
$params = [
...
if ($filial_id !== "") {
    $filtro .= " AND s.id_solicitante = :filial_id ";
...
JOIN solicitacoes_pagamento s ON s.ID = i.solicitacao_id
WHERE $filtro
