    ...
    <div class="layout-container">
        ...
        <ul class="menu-inner py-1">
          ...
          <li class="menu-item active open">
            ...
            <ul class="menu-sub">
              ...
              <li class="menu-item active"><a href="./produtosEnviados.php?id=<?= urlencode($idSelecionado); ?>"
                  class="menu-link">
      ...
      <div class="layout-page">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
          <h4 class="fw-bold mb-0"><span class="text-muted fw-light"><a href="#">B2B</a>/</span>Produtos Enviados</h4>
          <h5 class="fw-bold mt-3 mb-3 custor-font"><span class="text-muted fw-light">Visualize e gerencie os Envios
              Produtos para as Filiais</span></h5>
                  ...
                  <tbody class="table-border-bottom-0">
                    <tr>
                      ...
                      <td>
                        ...
                        <button class="btn btn-link text-info p-0" title="Visualizar Solicitação" data-bs-toggle="modal"
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <p><strong>Justificativa do Pedido:</strong> Necessidade de reposição de estoque devido ao aumento da
                    demanda de vendas durante o mês de abril.</p>
                  <p><strong>Status:</strong>Aprovação</p>
                  <p><strong>Comentário de Aprovação/Recusa:</strong> Necessidade de reposição de estoque devido ao
                    aumento da demanda de vendas durante o mês de abril.</p>
