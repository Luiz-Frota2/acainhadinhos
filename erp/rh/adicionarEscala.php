    ...
    <div class="layout-container">
            ...
            <ul class="menu-sub">
              <li class="menu-item">
                <a href="./escalaAdicionadas.php?id=<?= urlencode($idSelecionado); ?>" class="menu-link">
                  <div data-i18n="Basic">Escalas Adicionadas</div>
                </a>
              </li>
      ...
      <div class="layout-page">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
          <h4 class="fw-bold mb-0"><span class="text-muted fw-light"><a href="./escalaAdicionadas.php?id=<?= urlencode($idSelecionado); ?>">Sistema de
                Ponto</a>/</span>Adicionar escala</h4>
          <h5 class="fw-bold mt-3 mb-3 custor-font"><span class="text-muted fw-light">Adicione a Escala da sua Empresa
            </span></h5>
            ...
            <div class="col-xl">
              <div class="card mb-4">
                ...
                <div class="card-body">
                  ...
                  <form action="../../assets/php/rh/adicionarEscala.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control input-custom" name="nome_escala" id="nome_escala"
                        placeholder="Informe o nome do Setor" required />
                    </div>

                    <!-- Botão alinhado à direita -->
                    <div class="d-flex custom-button">
                      <button type="submit" class="btn btn-primary col-12 w-100 col-md-auto">Salvar Escala</button>
                    </div>
                  </form>
