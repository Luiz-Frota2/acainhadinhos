    ...
    <div class="layout-container">
      ...
      <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        ...
        <ul class="menu-inner py-1">
          ...
          <li class="menu-item">
            <a href="../financas/.php?id=<?= urlencode($idSelecionado); ?>" class="menu-link ">
          ...
          <li class="menu-item">
            <a href="../delivery/.php?id=<?= urlencode($idSelecionado); ?>" class="menu-link ">
              <i class="menu-icon tf-icons bx bx-cart"></i>
              <div data-i18n="Authentications">Delivery</div>
            </a>
          </li>
          <li class="menu-item">
            <a href="../estoque/.php?id=<?= urlencode($idSelecionado); ?>" class="menu-link ">
      ...
      <div class="layout-page">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
          <h4 class="fw-bold mb-0"><span class="text-muted fw-light"><a href="./escalaAdicionadas.php?id=<?= urlencode($idSelecionado); ?>">Sistema de Ponto</a>/</span>Adicionar escala</h4>
          <h5 class="fw-bold mt-3 mb-3 custor-font"><span class="text-muted fw-light">Adicione a Escala da sua Empresa </span></h5>
            ...
            <div class="col-xl">
              <div class="card mb-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                  <h5 class="mb-0">Formulário Escala</h5>
                </div>
                <div class="card-body">
                  <?php
                  ...
                  try {
                    // Busca os dados do setor pelo ID
                    $stmt = $pdo->prepare("SELECT * FROM escalas WHERE id = :id");
                    $stmt->bindParam(':id', $id, PDO::PARAM_INT);
                    $stmt->execute();
                    $escala = $stmt->fetch(PDO::FETCH_ASSOC);

                    // Se o setor não for encontrado
                    if (!$escala) {
                      echo "<script>
                  ...
                  ?>
                  <!-- form -->
                  <form action="../../assets/php/rh/atualizarEscala.php" method="POST" enctype="multipart/form-data">
                    <input type="hidden" name="id" value="<?= htmlspecialchars($escala['id']) ?>">
                    <!-- Imagem e Nome da Empresa (Lado a Lado ou Empilhado no Mobile) -->


                    <!-- Nome da Empresa -->
                    <div class="mb-3 ">
                      <label class="form-label" for="nome_escala">Tipo da escala</label>
                      <input type="text" class="form-control input-custom" name="nome_escala" id="nome_escala" value="<?= htmlspecialchars($escala['nome_escala']) ?>" required />
                    </div>

                    <input type="hidden" name="data_escala" value="<?= htmlspecialchars($escala['data_escala']) ?>">

                    <!-- Botão alinhado à direita -->
                    <div class="d-flex custom-button ">
                      <button type="submit" class="btn btn-primary col-12 w-100 col-md-auto">Editar Escala </button>
                    </div>
