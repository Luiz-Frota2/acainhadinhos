...
try {
  // Aqui ajustamos a consulta para considerar o prefixo "principal_" ou "filial_"
  $stmt = $pdo->prepare("SELECT * FROM funcionarios WHERE empresa_id = :empresa_id");
  $empresaIdFilial = str_starts_with($idSelecionado, 'filial_') ? "filial_$id" : "principal_$id";
  $stmt->bindParam(':empresa_id', $empresaIdFilial, PDO::PARAM_STR); // Usa o ID da empresa/filial com o prefixo
  $stmt->execute();
    ...
    <div class="layout-container">
            ...
            <ul class="menu-sub">
              ...
              <li class="menu-item active">
                <a href="#" class="menu-link">
                  <div data-i18n="Registro de Ponto Eletrônico">Adicionar Ajuste </div>
                </a>
              </li>
              <li class="menu-item">
      ...
      <div class="layout-page">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
          <h4 class="fw-bold mb-0"><span class="text-muted fw-light"><a href="./ajustePonto.php?id=<?= urlencode($idSelecionado); ?>">Sistema de
                Ponto</a>/</span>Adcionar ajuste de Ponto</h4>
          <h5 class="fw-bold mt-3 mb-3 custor-font"><span class="text-muted fw-light">Adicione e ajuste os pontos</span>
          </h5>

          <div class="card">
            <h5 class="card-header">Formulário de Ajuste de Ponto</h5>
            <div class="card-body">
              <form>
                <div class="row">
                  <!-- Funcionário -->
                  <div class="col-md-6">
                    ...
                    <select id="funcionario" class="form-select">
                      ...
                      <!-- Aqui você pode adicionar as opções dos funcionários cadastrados no sistema -->
                  ...
                  <!-- Data -->
                  <div class="col-md-6">
                    <label for="dataPonto" class="form-label">Data do Ponto</label>
                ...
                <div class="row mt-3">
                  ...
                  <div class="col-md-6">
                    ...
                    <input type="time" id="horaSaida" class="form-control" />
                  </div>
                </div>
                ...
                <div class="row mt-3">
                  ...
                  <div class="col-md-12">
                    ...
                    <textarea id="motivoAjuste" class="form-control" rows="3"
                      placeholder="Exemplo: Erro de registro, horário alterado, etc."></textarea>
                  </div>
                </div>

                <div class="row mt-3 justify-content-between">
                  <div class="col-12 col-md-3 d-grid mb-3">
                    <button type="button" class="btn btn-secondary prev-step">Cancelar</button>
                  </div>
                  <div class="col-12 col-md-3 d-grid mb-3 ms-md-auto">
