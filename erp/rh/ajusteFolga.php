...
<head>
  ...
  <title>ERP - Ajuste de Folgas</title>
      ...
      <div class="layout-page">
            ...
            <div class="navbar-nav align-items-center">
              <div class="nav-item d-flex align-items-center">
                ...
                <input type="text" class="form-control border-0 shadow-none" id="searchInput"
                  placeholder="Buscar funcionários..." aria-label="Search..." />
              </div>
            </div>
            <!-- /Search -->
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
          <h4 class="fw-bold mb-0"><span class="text-muted fw-light"><a href="#">Sistema de Ponto</a>/</span>Ajuste de
            Folgas</h4>
          <h5 class="fw-bold mt-3 mb-3 custor-font"><span class="text-muted fw-light">Visualize e ajuste as folgas dos funcionários</span></h5>

          <!-- Tabela de Ajuste de Folgas -->
        ...
        <script>
          ...
          const linhas = Array.from(document.querySelectorAll('#tabelaAjuste tbody tr'));
