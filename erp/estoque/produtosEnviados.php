    ...
    <div class="layout-container">
      ...
      <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        ...
        <ul class="menu-inner py-1">
          ...
          <li class="menu-item active open">
            ...
            <ul class="menu-sub">
              <li class="menu-item active"><a href="./produtosEnviados.php?id=<?= urlencode($idSelecionado); ?>" class="menu-link">
          ...
          <li class="menu-item">
            <a href="../delivery/index.php?id=<?= urlencode($idSelecionado); ?></a>" class="menu-link ">
      ...
      <div class="layout-page">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
          <h4 class="fw-bold mb-0"><span class="text-muted fw-light"><a href="./produtosEnviados.php">B2B</a>/</span>Produtos Enviados</h4>
          <h5 class="fw-bold mt-3 mb-3 custor-font"><span class="text-muted fw-light">Visualize e gerencie os Envios Produtos para as Filiais</span></h5>
                  ...
                  <tbody class="table-border-bottom-0">
                    <tr>
                      ...
                      <td>
                        ...
                        <button class="btn btn-link text-info p-0" title="Visualizar Solicitação" data-bs-toggle="modal" data-bs-target="#visualizarSolicitacaoModal">
          ...
          <div class="modal fade" id="visualizarSolicitacaoModal" tabindex="-1" aria-labelledby="visualizarSolicitacaoModalLabel" aria-hidden="true">
            <div class="modal-dialog">
              <div class="modal-content">

                <div class="modal-header">
                  <h5 class="modal-title" id="visualizarSolicitacaoModalLabel">Solicitação de Produto</h5>
                ...
                <div class="modal-body">
                  ...
                  <p><strong>Justificativa do Pedido:</strong> Necessidade de reposição de estoque devido ao aumento da demanda de vendas durante o mês de abril.</p>
                  <p><strong>Status:</strong>Aprovação</p>
                  <p><strong>Comentário de Aprovação/Recusa:</strong> Necessidade de reposição de estoque devido ao aumento da demanda de vendas durante o mês de abril.</p>
