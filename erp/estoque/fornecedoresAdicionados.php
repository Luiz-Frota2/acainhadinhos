                    ...
                    <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
                        ...
                        <div class="navbar-nav align-items-center">
                            <div class="nav-item d-flex align-items-center">
                                ...
                                <input type="text" id="inputPesquisarFornecedores" class="form-control border-0 shadow-none" placeholder="Pesquisar..."
                                    aria-label="Search..." />
                            </div>
                        </div>
                        <!-- /Search -->
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <div class="card">
                        ...
                        <div class="table-responsive text-nowrap">
                            <table class="table table-hover" id="tabelaFornecedoresAdicionados">
                                <thead>
                                    <tr>
                    ...
                    <script>
                        ...
                        const allRows = Array.from(document.querySelectorAll('#tabelaFornecedoresAdicionados tbody tr'));
