...
if (str_starts_with($idSelecionado, 'principal_')) {
  ...
  $tipoEmpresa = 'unidade';
  // lógica para franquia ou filial com base na tabela unidades
} else {
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="d-grid gap-3 text-center mb-3">
              <a href="../frentedeloja/index.php?id=<?= htmlspecialchars($idSelecionado) ?>" class="btn btn-outline-primary btn-lg">
