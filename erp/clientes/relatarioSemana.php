    ...
    <div class="layout-container">
      ...
      <div class="layout-page">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
          <h4 class="fw-bold mb-0"><span class="text-muted fw-light"><a href="./comprouMais.php">Relátorio</a>/</span>Semanal</h4>
          <h5 class="fw-bold mt-3 mb-3 custor-font"><span class="text-muted fw-light">Visualize o Ranking Semanal de todos os Clientes</span></h5>

          <!-- Tabela de Contas da Empresa -->
          <div class="card">
            <h5 class="card-header">Ranking Semanal</h5>
            <div class="card">
