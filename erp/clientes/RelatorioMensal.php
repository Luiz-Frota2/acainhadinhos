    ...
    <div class="layout-container">
      ...
      <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        ...
        <ul class="menu-inner py-1">
          ...
          <li class="menu-item">
            ...
            <ul class="menu-sub">
              <li class="menu-item">
                <a href="./clientesFisica.php?id=<?= urlencode($idSelecionado); ?>" class="menu-link">
          ...
          <li class="menu-item">
            ...
            <ul class="menu-sub">
              <li class="menu-item"><a href="./clientesDelivery.php?id=<?= urlencode($idSelecionado); ?>" class="menu-link">
          ...
          <li class="menu-item active open">
            ...
            <ul class="menu-sub">
              <li class="menu-item">
                <a href="./ComprouMais.php?id=<?= urlencode($idSelecionado); ?>" class="menu-link">
                  <div>Comprou Mais</div>
                </a>
              </li>
              <li class="menu-item">
                <a href="./relatarioSemana.php?id=<?= urlencode($idSelecionado); ?>" class="menu-link">
                  <div>Semanal </div>
                </a>
              </li>
              <li class="menu-item active">
                <a href="./RelatorioMensal.php?id=<?= urlencode($idSelecionado); ?>" class="menu-link">
                  <div>Mensal</div>
                </a>
              </li>
          ...
          <li class="menu-item">
            <a href="../financas/index.php?id=<?= urlencode($idSelecionado); ?></a>" class="menu-link ">
      ...
      <div class="layout-page">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
          <h4 class="fw-bold mb-0"><span class="text-muted fw-light"><a href="./comprouMais.php">Relátorio</a>/</span>Mensal</h4>
          <h5 class="fw-bold mt-3 mb-3 custor-font"><span class="text-muted fw-light">Visualize o Ranking Mensal de todos os Clientes</span></h5>

          <!-- Tabela de Contas da Empresa -->
          <div class="card">
            <h5 class="card-header">Ranking Mensal</h5>
            <div class="card">
