        ...
        <ul class="menu-inner py-1">
          ...
          <li class="menu-item active">
            <a href=".contaUsuario.php?id=<?= urlencode($idSelecionado); ?>" class="menu-link">
              ...
              <div data-i18n="Basic">Minha Conta</div>
            </a>
          </li>
          <!--END MISC-->
        </ul>
                  ...
                  <div class="card-body">
                    <div class="d-flex align-items-start align-items-sm-center gap-4">
                      ...
                      <div class="button-wrapper">
                        ...
                        <p class="text-muted mb-0">Permitido JPG, GIF ou PNG. Tamanho máximo de 800Kb</p>
                      </div>
                    </div>
                  </div>
                  <hr class="my-0" />
                  ...
                  <div class="card-body">
                    ...
                    <form id="formAccountDeactivation" onsubmit="return false">
                      <div class="form-check mb-3">
                        ...
                        <label class="form-check-label" for="accountActivation">Confirmo minha conta Desativação</label>
                      </div>
