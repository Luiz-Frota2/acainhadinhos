    ...
    <div class="layout-container">
      ...
      <div class="layout-page">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
          ...
          <h4 class="fw-bold mb-0"><span class="text-muted fw-light"><a href="./contasAdicionadas.php">Contas da Empresa</a>/</span>Visualizar Contas</h4>
          ...
          <div class="card">
            ...
            <div class="table-responsive text-nowrap">
              ...
              try {
                ...
                $sql = "SELECT * FROM contas WHERE statuss = 'futura'";
                $stmt = $pdo->query($sql);
                          ...
                          <div class="modal-dialog">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                ...
                                <a href="../../assets/php/financas/excluirContaFutura.php?id=<?= $conta['id'] ?>&&empresa_id=<?= htmlspecialchars($idSelecionado) ?>" class="btn btn-danger">Sim, excluir</a>
                        ...
                        <div class="modal fade" id="editContaModal_<?= $conta['id'] ?>" tabindex="-1" aria-labelledby="editContaModalLabel_<?= $conta['id'] ?>" aria-hidden="true">
                          <div class="modal-dialog">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                <form action="../../assets/php/financas/editarContaFutura.php?id=<?= urlencode($idSelecionado); ?>" method="POST">
                                  <!-- ID da conta -->
