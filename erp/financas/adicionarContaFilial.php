...
<body>
    ...
    <div class="layout-container">
      ...
      <div class="layout-page">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
          <h4 class="fw-bold mb-0"><span class="text-muted fw-light"><a href="#">B2B</a>/</span> Adicionar Contas Filiais</h4>
          <h5 class=" mt-3 mb-3 custor-font"><span class="text-muted fw-light">Cadastre uma nova conta de filial</span></h5>

          <!-- Formulário de Adicionar Conta -->
          <div class="card">
            <h5 class="card-header">Cadastro de Nova Conta Filial</h5>
            <div class="card-body">
              <form id="adicionarContaFilialForm">
                <div class="mb-3">
                  <label for="descricaoConta" class="form-label">Descrição</label>
                  <input type="text" class="form-control" id="descricaoConta" placeholder="Descrição da Conta" required />
                </div>

                <div class="mb-3">
                  <label for="valorConta" class="form-label">Valor</label>
                  <input type="number" class="form-control" id="valorConta" placeholder="Valor da Conta" required />
                </div>
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="responsavel" placeholder="Responsável pela Conta" required />
                </div>

                <div class="mb-3">
                  <label for="statusConta" class="form-label">Status</label>
                  <select class="form-select" id="statusConta" required>
  ...
  <script>
    document.getElementById('adicionarContaFilialForm').addEventListener('submit', function(event) {
      event.preventDefault();
      // Aqui você pode implementar a lógica para salvar os dados do formulário, como envio via AJAX ou integração com o backend.
      alert('Conta adicionada com sucesso!');
      window.location.href = './contaFiliais.php'; // Redireciona para a página de contas filiais após o cadastro.
    });
  </script>
</body>
