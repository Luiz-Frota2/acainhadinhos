                          ...
                          <div class="modal-dialog">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                ...
                                <a href="../../assets/php/financas/excluirContaPendente.php?id=<?= $conta['id'] ?>" class="btn btn-danger">Sim, excluir</a>
                        ...
                        <div class="modal fade" id="editContaModal_<?= $conta['id'] ?>" tabindex="-1" aria-labelledby="editContaModalLabel_<?= $conta['id'] ?>" aria-hidden="true">
                          <div class="modal-dialog">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                <form action="../../assets/php/financas/editarContasPendente.php" method="POST">
                                  <!-- ID da conta -->
