...
<head>
    ...
    <style>
        ...
        .badge-primary-soft { color:#4f46e5; background:#eef2ff; border-color:#e0e7ff; }   /* pendente */
        .badge-info-soft    { color:#0ea5e9; background:#e0f2fe; border-color:#bae6fd; }   /* aprovada */
        .badge-success-soft { color:#16a34a; background:#ecfdf5; border-color:#bbf7d0; }   /* paga */
        .badge-danger-soft  { color:#b91c1c; background:#fee2e2; border-color:#fecaca; }   /* recusada */
        .badge-secondary-soft { color:#475569; background:#f1f5f9; border-color:#e2e8f0; } /* cancelada/outros */

        #paginacao button { margin-right: 5px; }
        td.col-desc { max-width: 420px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
        td.col-forn-doc { max-width: 280px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
    </style>
</head>
<body>
            ...
            <ul class="menu-inner py-1">
                ...
                <li class="menu-item open active">
                    ...
                    <ul class="menu-sub active">
                        ...
                        <li class="menu-item active"><a class="menu-link" href="./solicitarPagamentoConta.php?id=<?= urlencode($idSelecionado); ?>"><div>Solicitar Pagamento</div></a></li>
                    </ul>
                </li>
        ...
        <div class="layout-page">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <a href="./novaSolicitacaoPagamento.php?id=<?= urlencode($idSelecionado); ?>" class="btn btn-primary btn-sm">
                        <i class="bx bx-plus"></i> Nova Solicitação
                    </a>
                </div>
...
function statusClassSoftPag(s) {
    ...
    switch (s) {
        case 'pendente':  return 'badge-primary-soft';
        case 'aprovada':  return 'badge-info-soft';
        case 'paga':      return 'badge-success-soft';
        case 'recusada':  return 'badge-danger-soft';
        case 'cancelada': return 'badge-secondary-soft';
        default:          return 'badge-secondary-soft';
    }
}
function statusUpper(s) { return String(s || '').replace('_', ' ').toUpperCase(); }
function safe(str) {
    return String(str ?? '')
