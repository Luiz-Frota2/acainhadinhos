...
try {
    ...
    // Valores padrão se não encontrar registro
    $dinheiro = $formasPagamento['dinheiro'] ?? 0;
    $pix = $formasPagamento['pix'] ?? 0;
    $cartaoDebito = $formasPagamento['cartaoDebito'] ?? 0;
    $cartaoCredito = $formasPagamento['cartaoCredito'] ?? 0;
} catch (PDOException $e) {
        ...
        <div class="layout-container">
            ...
            <div class="layout-page">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <h4 class="fw-bold  mb-0" id="custon-title"><span class="text-muted fw-light"><a
                                href="./formaPagamento.php?id=<?= urlencode($idSelecionado); ?>">Configuração</a>/</span>Formas de Pagamento</h4>

                    <h5 class="fw-bold mt-3 mb-3 custor-font"><span class="text-muted fw-light">Selecione as opções de
                            pagemento da loja</span></h5>
                                ...
                                <div class="card-body">
                                    <div class="row align-items-center mb-3">
                                        ...
                                        <form action="../../assets/php/delivery/adicionarFormaPagamento.php" method="POST">
                                            ...
                                            <div class="col-12 col-md-12 check-card">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="infos"><strong>Dinheiro</strong></div>
                                                    <div class="d-flex align-items-center ms-auto">
                                                        <strong class="custom-option me-2"><?= $dinheiro ? 'Ativado' : 'Desligado' ?></strong>
                                                        <div class="form-check form-switch mt-2">
                                                            <input type="hidden" name="dinheiro" value="0">
                                                            <input class="form-check-input check w-px-50 h-px-20"
                                                                type="checkbox" name="dinheiro" value="1"
                                                                <?= $dinheiro ? 'checked' : '' ?> onchange="this.form.submit()">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <form action="../../assets/php/delivery/adicionarFormaPagamento.php" method="POST">
                                            ...
                                            <div class="col-12 col-md-12 check-card">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="infos"><strong>Pix</strong></div>
                                                    <div class="d-flex align-items-center ms-auto">
                                                        <strong class="custom-option me-2"><?= $pix ? 'Ativado' : 'Desligado' ?></strong>
                                                        <div class="form-check form-switch mt-2">
                                                            <input type="hidden" name="pix" value="0">
                                                            <input class="form-check-input check w-px-50 h-px-20"
                                                                type="checkbox" name="pix" value="1"
                                                                <?= $pix ? 'checked' : '' ?> onchange="this.form.submit()">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <form action="../../assets/php/delivery/adicionarFormaPagamento.php" method="POST">
                                            ...
                                            <div class="col-12 col-md-12 check-card">
                                                <div class="d-flex align-items-center">
                                                    <div class="img-icon-details"><i class="fas fa-credit-card"></i></div>
                                                    <div class="infos"><strong>Cartão de Débito</strong></div>
                                                    <div class="d-flex align-items-center ms-auto">
                                                        <strong class="custom-option me-2"><?= $cartaoDebito ? 'Ativado' : 'Desligado' ?></strong>
                                                        <div class="form-check form-switch mt-2">
                                                            <input type="hidden" name="cartaoDebito" value="0">
                                                            <input class="form-check-input check w-px-50 h-px-20"
                                                                type="checkbox" name="cartaoDebito" value="1"
                                                                <?= $cartaoDebito ? 'checked' : '' ?> onchange="this.form.submit()">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <form action="../../assets/php/delivery/adicionarFormaPagamento.php" method="POST">
                                            ...
                                            <div class="col-12 col-md-12 check-card">
                                                <div class="d-flex align-items-center">
                                                    <div class="img-icon-details"><i class="fas fa-credit-card"></i></div>
                                                    <div class="infos"><strong>Cartão de Crédito</strong></div>
                                                    <div class="d-flex align-items-center ms-auto">
                                                        <strong class="custom-option me-2"><?= $cartaoCredito ? 'Ativado' : 'Desligado' ?></strong>
                                                        <div class="form-check form-switch mt-2">
                                                            <input type="hidden" name="cartaoCredito" value="0">
                                                            <input class="form-check-input check w-px-50 h-px-20"
                                                                type="checkbox" name="cartaoCredito" value="1"
                                                                <?= $cartaoCredito ? 'checked' : '' ?> onchange="this.form.submit()">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    <h5 class="fw-bold py-3 mb-3 custor-font"><span class="text-muted fw-light">Selecione as opções de
                            pagemento online da loja </span></h5>

                    <div class="row">
                        <div class="col-12">
                            <div class="card alert-secondary custom-opacity">
                                <div class="card-body "> <!-- 10% de visibilidade -->
                                    <div class="row align-items-center mb-0">
                                        <div class="col-12 col-md-12 text-md-start">
                                            <div class="d-flex align-items-center">
                                                <div>
                                                    <i class="bx bx-cog"></i> <strong>Pagamentos Online em
                                                        Construção</strong>
                                                </div>
                                            </div>
                                        </div>
