                        ...
                        <div class="col-xl">
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <!-- form -->
                                    <form action="../../assets/php/delivery/adicionarProduto.php" method="POST"
                                        ...
                                        <div class="input-group input-group-merge mb-3">
                                            ...
                                            <input type="text" name="precoProduto" id="basic-default-company"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea id="basic-default-message" name="descricaoProduto"
                                                class="form-control"
                                                placeholder="Faça uma Descrição do Produto"></textarea>
                                        </div>

                                        <div class="d-flex custom-button ">
                                            <button type="submit"
                                                class="btn btn-primary col-12 w-100 col-md-auto">Salvar Produto</button>
                                        </div>
