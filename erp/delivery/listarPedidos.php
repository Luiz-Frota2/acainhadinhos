        ...
        <div class="layout-container">
            ...
            <div class="layout-page">
                ...
                <div class="container mt-4">
                    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Pedidos/</span>Lista de Pedidos</h4>
                    <div class="card">
                        ...
                        <div class="table-responsive text-nowrap">
                            <table class="table table-hover">
                                ...
                                <tbody class="table-border-bottom-0">
                                    <tr>
                                        <td><strong>Açaí Tradicional</strong> </td>
                                        <td>Lucas Correa</td>
                                        <td>20/10/2025</td>
                                        <td>Capitão pessoa 717, Chagas Aguiar</td>
                                        <td><span class="badge bg-label-danger me-1">Recusado</span></td>
                                    </tr>
                                    <tr>
                                        <td><strong>Açaí Tradicional</strong></td>
                                        <td>Lucas Correa</td>
                                        <td>20/10/2025</td>
                                        <td>Capitão pessoa 717, Chagas Aguiar</td>
                                        <td><span class="badge bg-label-primary me-1">Entregue</span></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
