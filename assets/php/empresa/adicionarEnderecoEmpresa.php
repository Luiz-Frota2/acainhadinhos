...
try {
    ...
    if ($enderecoExistente) {
        ...
        echo "<script>alert('Endereço atualizado com sucesso!'); window.location.href='../../../erp/empresa/enderecoEmpresa.php?id=$idSelecionado';</script>";
    } else {
        ...
        echo "<script>alert('Endereço cadastrado com sucesso!'); window.location.href='../../../erp/empresa/enderecoEmpresa.php?id=$idSelecionado';</script>";
    }
} catch (Exception $e) {
