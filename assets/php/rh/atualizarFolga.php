...
// Verifica os dados do POST
if (!isset($_POST['id'], $_POST['data_folga'], $_POST['cpf'], $_POST['empresa_id'], $_POST['mes'], $_POST['ano'])) {
...
try {
    ...
    if ($stmt->execute()) {
        // Redireciona de volta para a página exata
        $url = "Location: ../../../erp/rh/folgasIndividuaisDias.php?id=" . urlencode($idSelecionado) .
               "&cpf=" . urlencode($cpf) . "&mes=" . urlencode($mes) . "&ano=" . urlencode($ano);
        header($url);
        exit;
    } else {
