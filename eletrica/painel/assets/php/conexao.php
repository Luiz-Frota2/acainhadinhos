...
$dbname = 'u920914488_eletrica'; // Nome do banco de dados
$username = 'u920914488_eletrica'; // Seu nome de usuário do banco de dados
$password = 't^90p0V~'; // Sua senha do banco de dados
