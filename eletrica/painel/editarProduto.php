        ...
        <div class="layout-container">
            ...
            <ul class="menu-inner py-1">
                ...
                <li class="menu-item active open">
                    ...
                    <ul class="menu-sub">
                        <li class="menu-item active">
                            <a href="./adicionarProduto.html" class="menu-link" >
                ...
                <li class="menu-item">
                    ...
                    <ul class="menu-sub">
                    <li class="menu-item">
                        <a href="./hararioFuncionamento.html" class="menu-link" >
                ...
                <li class="menu-item">
                    <a href=".././dashboard.html" target="_blank" class="menu-link mb-4">
                      <i class="menu-icon tf-icons bx bx-log-out"></i>
                      <div data-i18n="Basic">Voltar</div>
                    </a>
                </li>
                <!--END MISC-->
            </ul>
            ...
            <div class="layout-page">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <h4 class="fw-bold mb-0"><span class="text-muted fw-light"><a href="./produtoAdicionados.php">Cardápio</a>/</span>Editar Produto</h4>
                    <h5 class="fw-bold mt-3 mb-3 custor-font"><span class="text-muted fw-light">Atualize as informações do produto</span></h5>
                                    ...
                                    <form action="./assets/php/delivery/editarProduto.php" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="d-flex align-items-center mb-4 form-container">
                                            ...
                                            <div class="position-relative">
                                                <label for="inputGroupFile02" class="position-relative">
                                                    <img id="previewImg" class="img-preview" src="./assets/img/uploads/<?php echo htmlspecialchars($produto['imagem_produto']); ?>">
                                                    <input type="file" class="d-none" name="imagemProduto" id="inputGroupFile02" accept="image/*" onchange="previewImage(event)" />
                                                    <div class="icon-overlay">
                                                        <i class="fas fa-image"></i> <!-- Ícone de Câmera -->
                                                    </div>
                                                </label>
                                            </div>
                                            ...
                                            <div class="ms-3 mt-4 flex-grow-1">
                                                <label class="form-label" for="nomeEmpresa">Nome do Produto</label>
                                                <input type="text" class="form-control input-custom" name="nomeProduto" value="<?php echo htmlspecialchars($produto['nome_produto']); ?>"/>
                                            </div>
                                        </div>
                    
                                        <div class="mb-3">
                                            <label class="form-label" for="basic-default-company">Quantidade</label>
                                            <input type="text" class="form-control" name="quantidadeProduto" value="<?php echo $produto['quantidade_produto']; ?>" />
                                        </div>
                                        ...
                                        <div class="input-group input-group-merge mb-3">
                                            <span class="input-group-text">R$</span>
                                                <input type="text" name="precoProduto" class="form-control" value="<?php echo number_format($produto['preco_produto'], 2, ',', '.'); ?>" aria-label="Amount (to the nearest dollar)">
                                            <span class="input-group-text"></span>
                                        </div>

                                        <div class="mb-3">
                                            <label class="form-label" for="basic-default-message">Descrição</label>
                                            <textarea id="basic-default-message" name="descricaoProduto" class="form-control"><?php echo htmlspecialchars($produto['descricao_produto']); ?></textarea>
                                        </div>

                                        <div class="d-flex custom-button ">
                                            <button type="submit" class="btn btn-primary col-12 w-100 col-md-auto">Editar Produto</button>
                                        </div>
