            ...
            <div class="layout-container">
                ...
                <div class="layout-page">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"><a href="./produtoAdicionados.php">Cardápio</a>/</span>Adicionar Produto</h4>
                            ...
                            <div class="col-xl">
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <!-- form -->
                                        <form action="./assets/php/delivery/adicionarProduto.php" method="POST" enctype="multipart/form-data">

                                            <!-- Campo oculto para enviar o id_categoria -->
                                            ...
                                            <div class="d-flex align-items-center mb-4 form-container">
                                                ...
                                                <div class="ms-3 mt-4 flex-grow-1">
                                                    ...
                                                    <input type="text" class="form-control" name="nomeProduto" id="basic-default-fullname" placeholder="Informe o nome do Produto" />
                                                </div>
                                            </div>
                        
                                            <div class="mb-3">
                                                <label class="form-label" for="basic-default-company">Quantidade</label>
                                                <input type="text" class="form-control" name="quantidadeProduto" id="basic-default-company" placeholder="Informe a Quantidade do Produto" />
                                            </div>
                                            ...
                                            <div class="input-group input-group-merge mb-3">
                                                ...
                                                <input type="text" name="precoProduto" id="basic-default-company" class="form-control" placeholder="100" aria-label="Amount (to the nearest dollar)">
                                                <span class="input-group-text"></span>
                                            </div>

                                            <div class="mb-3">
                                                <label class="form-label" for="basic-default-message">Descrição</label>
                                                <textarea id="basic-default-message" name="descricaoProduto" class="form-control" placeholder="Faça uma Descrição do Produto"></textarea>
                                            </div>
